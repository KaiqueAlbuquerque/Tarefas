<div id="mySidenav" class="sidenav">
		<img class="logo col-xs-6 col-sm-6 col-md-6 col-lg-6 img-responsive"
			src="Image/logo.png" alt="Logotipo Empresa"> <a
	...
	<div id="main">
		<nav class="navbar navbar-default"> <span id="close-nav"
			style="display: none; font-size: 35px; cursor: pointer; color: rgb(204, 204, 204); position: absolute; left: 14px;"
			onclick="openNav();">&#9776;</span> </nav>

...
<form action="Index.do" method="post">
	<div class="row col-md-12">
		...
		<div class="form-group">
			<div class="input-group col-md-4">
				<div class="input-group-addon"><span class="glyphicon glyphicon-asterisk" aria-hidden="true"></span>
				</div>
	...
	<div class="row col-md-12">
		<button type="submit" class="btn btn-primary" name="command" value="FazerLogin"><span class="glyphicon glyphicon-ok" ariahidden="true"></span> Ok</button>
	</div>
</form>
</div>
